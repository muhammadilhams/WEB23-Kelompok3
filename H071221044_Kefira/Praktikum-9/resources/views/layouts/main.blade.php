...
<body style="background-color: #EEEEEE">
        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" role="search" action="{{ route('jenis') }}" method="GET">
                    <input class="form-control me-3" type="search" name="jenis" placeholder="Search By Category"
                        aria-label="Search">
    ...
    <div class="container">
        @yield('container')
        <!-- digunakan untuk mendefinisikan sebuah "section" diisi dengan konten yang berbeda pada setiap halaman 
        yang meng-extend template ini. -->
    </div>
