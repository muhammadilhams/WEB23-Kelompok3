   ...
   <script>
     ...
     document.addEventListener('DOMContentLoaded', function () {
        document.getElementById('submitBtn').addEventListener('click', function (event) {
            ...
            var job = document.getElementsByName('field_job')[0].value;
            var descJob = document.getElementsByName('field_descJob')[0].value;
            var company = document.getElementsByName('field_company')[0].value;
            var email = document.getElementsByName('field_email')[0].value;
            var kontak = document.getElementsByName('field_kontak')[0].value;
            var lokasi = document.getElementsByName('field_lokasi')[0].value;
            var tersedia = document.getElementsByName('field_tersedia')[0].value;

            // Validasi
            if (job.trim() === '' || descJob.trim() === '' || company.trim() === '' || email.trim() === '' || kontak.trim() === '' || lokasi.trim() === '' || tersedia.trim() === '') {
