        ...
        <div class="col mb-5">
          <div class="card h-100">
            ...
            <div class="card-footer border-top-0 bg-transparent">
              <div class="text-center">
                <a class="btn btn-primary mt-auto" href="{{ route('contact', $car->slug) }}">Sewa</a>
                <a
                  class="btn btn-info mt-auto text-white"
                  href="{{ route('user.detail', $car->slug) }}"
                  >Detail</a
                >
              </div>
            </div>
        ...
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    <!-- Sale badge-->
                    <div
                        class="badge badge-custom {{ $driver->status == 'free' ? 'bg-success' : 'bg-success' }} text-white position-absolute"
                        style="top: 0; right: 0"
                    >
                        {{ $driver->status }}
                    </div>
                    ...
                    <div class="card-footer border-top-0 bg-transparent mb-3">
                        <div class="text-center">
                            <a class="btn btn-primary mt-auto" href="{{ route('contact') }}">Sewa</a>
                        </div>
                    </div>
                </div>
            </div>
