...
if (isset($_POST['logout'])) {
    session_destroy();
    header("location:../login.php?message=Sampai jumpa Kembali");
}
...
if ($op == 'edit') {
    ...
    $result = mysqli_query($connection->connect, $query); //jalankan query
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    ...
                                    <a href="?op=delete&id=<?= $data['id'] ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?')">
